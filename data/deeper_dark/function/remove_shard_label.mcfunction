...
item modify entity @n[tag=deeper_dark.item] weapon.mainhand [ { "function": "minecraft:set_lore", "entity": "this", "lore": [ [ { "score": { "objective": "deeper_dark.var", "name": "x" }, "color": "gray", "italic": false }, { "text": " " }, { "score": { "objective": "deeper_dark.var", "name": "y" } }, { "text": " " }, { "score": { "objective": "deeper_dark.var", "name": "z" } }, { "text": " " }, { "entity": "@s", "nbt": "SelectedItem.components.\"minecraft:custom_data\".deeper_dark.EntrancePosition.dim", "interpret": true } ] ], "mode": "replace_all" } ]
