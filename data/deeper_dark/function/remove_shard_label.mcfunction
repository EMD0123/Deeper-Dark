...
execute store success score compare deeper_dark.var run data modify entity @n[tag=deeper_dark.item] HandItems[0].components."minecraft:lore".[0] set from storage deeper_dark:data shardlines[0]
