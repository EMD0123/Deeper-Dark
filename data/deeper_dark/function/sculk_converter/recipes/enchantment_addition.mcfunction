...
data modify entity @e[tag=deeper_dark.sculk_converter.recipes.item2,limit=1,sort=nearest] HandItems[0] set from entity @s data.Item
...
execute if data entity @n[tag=deeper_dark.sculk_converter.recipes.item] item.components.minecraft:enchantments.levels unless data entity @n[tag=deeper_dark.sculk_converter.recipes.item] {item:{id:"minecraft:enchanted_book"}} run function deeper_dark:sculk_converter/recipes/enchantment_addition/get1 with entity @e[tag=deeper_dark.sculk_converter.recipes.item,limit=1,sort=nearest] item.components."minecraft:enchantments"
