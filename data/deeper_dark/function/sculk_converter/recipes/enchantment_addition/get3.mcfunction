...
$execute store result score old deeper_dark.var run data get entity @e[tag=deeper_dark.sculk_converter.recipes.item2,limit=1,sort=nearest] equipment.mainhand.components."minecraft:enchantments".levels."$(enchantment)"
